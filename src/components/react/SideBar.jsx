...
export const SideBar = () => {
    ...
    return (
        <nav className="text-sm text-darkGrayishBlueCustom">
            ...
            <ul className={"fixed z-[90] top-0 left-0 w-[65%] sm:w-[35%] h-screen text-xl bg-white pt-24 pl-6 flex flex-col gap-6 font-bold text-veryDarkBlueCustom after:content-[''] after:absolute after:top-0 after:left-[100%] after:w-screen after:h-full after:bg-black after:opacity-60 after:z-[90] "
