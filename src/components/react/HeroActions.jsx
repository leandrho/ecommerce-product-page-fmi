...
export const HeroActions = ({product}) => {
    ...
    return (
        <>
            <div className="flex flex-col gap-4 lg:gap-8"> {/* Contenedor */}
                <div className="flex items-center justify-between w-full lg:flex-col lg:items-start lg:gap-2"> {/* price section */}
                ...
                <div className="flex flex-col gap-4 lg:flex-row">
                    <div className="lg:min-w-[156px]">{/* Count of product */}
                        <div className="h-14 rounded-lg px-6 flex justify-between items-center bg-lightBrayishBlueCustom"> {/* Box */}
                            <button className="text-orangeCustom hover:text-hoverOrange"
                                    onClick={()=>decrement()}
                                    arial-label="Increment Cart" 
                                    >
